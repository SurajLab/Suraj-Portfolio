      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ agrawalsuraj2004@gmail.com | 📞 +91 6203437045
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            ...
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — Wetge Public School</strong> (CBSE, 2023) <br />
              <span style={{ color: "#aaa" }}>Percentage: 60%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Carmel High School</strong> (JAC Board, 2021)
              <br />
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>1️⃣ Property rental application using MERN Stack</li>
          </ul>
        </motion.div>
        ...
        >
          {[
            ...
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/suraj404" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}
